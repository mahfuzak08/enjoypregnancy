					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-md-12 col-lg-5 login-right">
							<div class="login-header">
								<h3>Register Your Pharmacy with <span>Maulaji</span></h3>
							</div>
              ...
              <?php } ?>
	             ...
	             <div class="clearfix reg_inputs">
	                <div class="form-group form-focus simplenumberdiv">
										...
										<label class="focus-label" id="identity-label">Pharmacy Name</label>
									</div>
                  
                  <div class="form-group form-focus simplenumberdiv">
                    <input type="email" class="form-control floating" name="email" id="email_i" required>
                    <label class="focus-label" id="identity-label">Pharmacy Email</label>
                  </div>

	                <div class="form-group form-focus simplenumberdiv">
										<input type="text" class="form-control floating" name="address" id="address" required>
										<label class="focus-label" id="identity-label">Pharmacy Address</label>
									</div>
	                ...
	                <div class="form-group form-focus otpnumberdiv">
										<div class="input-group mb-3">									
										    ...
										    <label class="focus-label" style="text-indent: 58px;z-index: 9999;">Pharmacy Phone</label>
										</div>									
									</div>
