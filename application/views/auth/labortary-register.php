			...
			<div class="col-md-10 offset-md-1">
					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-md-12 col-lg-5 login-right">
							<div class="login-header">
								<h3>Register Your Laboratory with <span>Maulaji</span></h3>
							</div>
                ...
                <div class="clearfix reg_inputs">
                    ...
                    <div class="form-group form-focus simplenumberdiv">
										...
										<label class="focus-label" id="identity-label">Laboratory Name</label>
									</div>
                  <!-- <div class="form-group">
                  ...
                  <div class="form-group form-focus simplenumberdiv">
										...
										<label class="focus-label" id="identity-label">Laboratory Address</label>
									</div>
                  <!-- <div class="form-group">
                  ...
                  <div class="form-group form-focus simplenumberdiv">
										...
										<label class="focus-label" id="identity-label">Laboratory Email</label>
									</div>
                  <!-- <div class="form-group">
                  ...
                  <div class="form-group form-focus otpnumberdiv">
										<div class="input-group mb-3">									
										    ...
										    <label class="focus-label" style="text-indent: 58px;z-index: 9999;">Laboratory Phone</label>
										</div>									
									</div>
