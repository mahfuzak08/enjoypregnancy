<?php $page_name = array("Home", "Pharmacy", "Lab Test"); ?>
<!--sidebar end-->
<!--main content start-->
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($slides as $slide) { ?>
                            <tr class="">
                                ...
                                <td> <?php echo $slide->page_name; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="addEditSlide" action="slide/addNew" class="clearfix" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control m-bot15" name="page_name" value=''>
							<?php for($i=0; $i<count($page_name); $i++) { ?>
							<option value="<?= $page_name[$i]; ?>" <?php
							if (!empty($slide->page_name) && $slide->page_name == $page_name[$i]) {
								echo 'selected';
							}
							?> > <?= $page_name[$i]; ?> 
							</option>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="" class="clearfix" action="slide/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                        <input type="text" class="form-control" name="title" id="exampleInputEmail1" value=''>
                    </div>
    ...
    $(document).ready(function () {
        $(".editbutton").click(function (e) {
            ...
            $.ajax({
                ...
                $('#addEditSlide').find('[name="id"]').val(response.slide.id).end()
                $('#addEditSlide').find('[name="title"]').val(response.slide.title).end()
                $('#addEditSlide').find('[name="text1"]').val(response.slide.text1).end()
                $('#addEditSlide').find('[name="text2"]').val(response.slide.text2).end()
                $('#addEditSlide').find('[name="text3"]').val(response.slide.text3).end()
                $('#addEditSlide').find('[name="position"]').val(response.slide.position).end()
                $('#addEditSlide').find('[name="status"]').val(response.slide.status).end()
                $('#addEditSlide').find('[name="page_name"]').val(response.slide.page_name).end()
