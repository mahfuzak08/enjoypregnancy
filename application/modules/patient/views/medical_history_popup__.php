        ...
        <script>
            ...
            $('.mediapanel').on('click', ' .mediaBtn ', function (event) {
                ...
                popup(url, '', screen.width, screen.height);
            })
            })
    </script>
        ...
        <script>
            ...
            {
                $.get('https://callgpnow.com/public/doctor/getToken').done(response=>{
                    if ( !window.phone ){
                        ...
                        <script>
                            $(document).ready(function () {
                                ...
                                $('#prescriptionPop').on('click', ' .viewPrescriptionbtn ', function (event) {
                                    ...
                                    popup('<?=base_url()?>prescription/viewPrescription?type=1&id='+id, '', screen.width, screen.height);
                                })
...
//////////////////////////Edit/////////////////////////////
                                $("#prescriptionPop").on("click", ".editPrescriptionBtn", function () {
                                    var id = $(this).data('ref');
                                    popup('<?=base_url()?>prescription/editPrescription?type=1&id='+id, '', screen.width, screen.height);
                                });


                                $('#prescriptionPop').on('click', '#addPrescriptionBtn', function (event) {
                                    var id = $(this).data('ref');
                                    popup('<?=base_url()?>prescription/addPrescriptionView?type=1', '', screen.width, screen.height);
                                })


                                $('#prescriptionPop').on('click', '.printPrescriptionbtn', function (event) {
                                    var id = $(this).data('ref');
                                    popup('<?=base_url()?>prescription/viewPrescriptionPrint?type=1&id='+id, '', screen.width, screen.height);
                                })
                        ...
                        <script>
                            $(document).ready(function () {
                                ...
                                $('#MedicalNoteTable').on('click', '.viewTreatmentButton', function (event) {
                                    var id = $(this).data('ref');
                                    popup('<?=base_url()?>prescription/bodychartview?id='+id, '', screen.width, screen.height);
                                })
