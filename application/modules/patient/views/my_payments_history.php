            ...
            <div class=" panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <section class="col-md-12 no-print row">
                        <form role="form" class="f_report" action="<?= base_url('patient/myPaymentHistory'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 no-print">
                                    <button type="submit" name="submit" class="btn btn-info range_submit"><?php echo lang('search'); ?></button>
                                </div>
                            </div>
                        </form>
                    </section>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-samples">
                        <thead>
                            <tr>
                                ...
                                <th class=""><?php echo 'Payment method'; ?></th>
                                <th class="no-print"><?php echo lang('options'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php $total = 0;
                            foreach ($payment_history as $row) { $total+= $row->amount; ?>
								<tr class="">
									<td><?= $row->createdat; ?></td>
									<td><?= $row->id; ?></td>
									<td><?= number_format($row->amount, 2, '.', ','); ?></td>
									<td><?= ucfirst(substr($row->method, 3)); ?></td>
									<td  class="no-print"> 
										<a class="btn-xs invoicebutton" title="<?php echo lang('invoice'); ?>" style="color: #fff; width: 23px;" href="patient/viewInvoice/<?php echo $row->order_no; ?>"><i class="fas fa-file-invoice"></i> </a>
									</td>
								</tr><?php
                            }
                            ?>
