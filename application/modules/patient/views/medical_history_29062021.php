            ...
            <section class="panel-body">   
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <?php } ?>
                        <li class="">
                            <a data-toggle="tab" href="#lab"><?php echo 'Diagnostic Tests'; ?></a>
                        </li>
                        <li class="">
                                            ...
                                            <?php foreach ($appointments as $appointment) { ?>
                                                <tr class="">
                                                    <td>
                                                        ...
                                                        echo '<a href="frontend/doctor_profile/'.$appointment->doctor.'" target="_blank">'.$appointment_doctor.'</a>';
                                                        ?>
                                                    </td>
                                                    ...
                                                    <td><?php echo $appointment->status; ?></td>
                                                        ...
                                                        <td class="no-print">
                                                            ...
                                                            <?php if($appointment->status == 'Confirmed') {
                                                                // echo $options7 = '<a class="btn btn-info btn-xs btn_width detailsbutton" title="' . lang('start_live') . '" style="color: #fff;" href="meeting/instantLive?id=' . $appointment->id . '" target="_blank" onclick="return confirm(\'Are you sure you want to start a live meeting?\');"><i class="fa fa-headphones"></i> ' . lang('live') . '</a>';
