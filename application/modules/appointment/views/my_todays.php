        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="appointment/addNew" method="post" class="clearfix" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('reasons'); ?></label>
            ...
            <div class="modal-body row">
                <form role="form" id="editAppointmentForm" action="appointment/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="col-md-6 panel">
                        ...
                        <select class="form-control m-bot15 pos_select patient" id="pos_select" name="patient1" value='' disabled="disabled"> 
                    ...
                    <div class="col-md-6 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('appointment'); ?> <?php echo lang('status'); ?></label> 
                        <input type="text" class="form-control m-bot15" name="status" value='' readonly="readonly">
                            <!-- <option value="Pending Confirmation" <?php
                                ?> > <?php echo lang('pending_confirmation'); ?> </option>
                            <option value="Confirmed" <?php
                                ?> > <?php echo lang('confirmed'); ?> </option>
                    ...
                    <div class="col-md-6 panel">
                        ...
                        <textarea class="form-control" name="remarks" id="" value='' placeholder=""></textarea>
                    </div>
                    <!--     <div class="col-md-6 panel">
                         <label> <?php echo lang('send_sms'); ?> ? </label> <br>
                         <input type="checkbox" name="sms" class="" value="sms">  <?php echo lang('yes'); ?>
                    ...
                    <input type="hidden" name="redirect" value='appointment/myTodays'>
                    <div class="col-md-12 panel">
                        <button type="submit" name="submit" class="btn btn-info pull-right"> <?php echo lang('submit'); ?></button>
                    </div>
                </form>
    ...
    $(document).ready(function () {
        $(".table").on("click", ".editbutton", function () {
            ...
            $.ajax({
                ...
                $('#editAppointmentForm').find('[name="patient1"]').val(response.appointment.patient).end()
                $('#editAppointmentForm').find('[name="doctor1"]').val(response.appointment.doctor).end()
                ...
                $('#editAppointmentForm').find('[name="patient1"]').append(option).trigger('change');
