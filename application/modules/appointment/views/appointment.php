        ...
        <section class="panel">
            ...
            <div class="col-md-12">
                <header class="panel-heading tab-bg-dark-navy-blueee row">
                    <ul class="nav nav-tabs col-md-12">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#urgent_booking"><?php echo 'Urgent'; ?></a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#home_visit_booking"><?php echo 'Home Visit'; ?></a>
                        </li>
                    </ul>
            ...
            <div class="">
                <div class="tab-content">
                    <div id="urgent_booking" class="tab-pane">
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    <div class="space15"></div>
                                    <table class="table table-striped table-hover table-bordered" id="" style="width: 100%;">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php $i=1; foreach($urgent_appointment_requests as $key => $value){ ?>
                                            <tr>
                                                <td>
                                                    <?php echo $i++; ?>
                                                </td>
                                                <td>
                                                    <a type="button" href="javascript:void(0)" class="historyBtn" data-pid="<?php echo $value->patient_id ?>"><?php echo $value->patient_name ?></a>
                                                </td>
                                                <td>
                                                    <?php $this->db->where('id',$value->dr_id); $doc_arr = $this->db->get('doctor')->row_array(); echo $doc_arr['name']; ?>
                                                </td>
                                                <td>
                                                    <?php echo date('Y-m-d H:i',strtotime($value->created_at)) ?>
                                                </td>
                                                <td>
                                                    <?php if($value->status==0){ echo "Pending";}else{ echo "Completed"; } ?>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#urgent_modal">Edit</button>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                    ...
                    <div id="home_visit_booking" class="tab-pane">
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    <div class="space15"></div>
                                    <table class="table table-striped table-hover table-bordered" id="" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php $i=1; foreach($home_appointment_requests as $key => $value){ ?>
                                            <tr>
                                                <td>
                                                    <?php echo $i++; ?>
                                                </td>
...
<!-- Urgent modal -->
<!-- Edit Event Modal-->
<div class="modal fade" id="urgent_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog ">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title">  <?php echo 'Edit Urgent Appointment'; ?></h4>
        </div>
...
*/
    ...
    function sendSms()
    {
        ...
        $.post('https://maulaji.com/doctor/sendMessage',{
            to: phone,
            body: message
        }).done(response=>{
    ...
    function sendEmail()
    {
        ...
        $.post('https://maulaji.com/doctor/sendEmail',{
            email: email,
            body: message
        }).done(response=>{
            response = JSON.parse(response);
...
<!-- end for add medical note popup-->
...
<div class="modal fade" id="smsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close CloseModalBtn" data-dismiss="modal" aria-hidden="true">×</button>
