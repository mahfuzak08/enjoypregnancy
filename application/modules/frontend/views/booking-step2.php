								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group card-label">
											...
											<input class="form-control" type="date" data-date="" data-date-format="DD MMMM YYYY"  name="date" id="appointment_date" value="<?= date("Y-m-d"); ?>">
											<input class="form-control" type="hidden" name="date_of_birth" value="<?= @$patient_data->birthdate; ?>">
										</div>
									</div>									
									<div class="col-md-6 col-sm-12">
										<div class="form-group card-label">
						...
						<div class="booking-summary">
							<div class="booking-item-wrap">
								<ul class="booking-date">
									<li>Consulting Date <span id="consult_date_span"><?= date("Y-m-d"); ?></span></li>
...
$("#appointment_date").on("change", function(){
	$("#consult_date_span").text($("#appointment_date").val());
});
