						...
						<form action="frontend/bookhomevisittnow" method="post" enctype="multipart/form-data">
							...
							<div class="payment-widget">
								...
								<div class="submit-section mt-4">
									...
									<input type="hidden" name="hospital_id" value="<?php echo $doctor_data->hospital_id; ?>">
						...
						<div class="booking-summary">
							<div class="booking-item-wrap">
								...
								<ul class="booking-fee">
									<li>Booking Fee <span><?php if($doctor_data->home_fee =="" or $doctor_data->home_fee =="free"){ ?> Free <?php }else{ echo $doctor_data->symbol. ' '. $doctor_data->home_fee; } ?></span></li>
								...
								<div class="booking-total">
									<ul class="booking-total-list">
										<li>
											<span>Total</span>
											<span class="total-cost"><?php if($doctor_data->home_fee =="" or $doctor_data->home_fee =="free"){ ?> 0 <?php }else{ echo $doctor_data->symbol. ' '. $doctor_data->home_fee; } ?></span>
										</li>
									</ul>
								</div>
							</div>
