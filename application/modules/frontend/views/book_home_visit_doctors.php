                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8 col-12">
                            ...
                            <h2 class="breadcrumb-title">Book home visit with top doctors</h2>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-5 col-xl-4 theiaStickySidebar">
                            ...
                            <div class="card search-filter">
                                ...
                                <div class="card-body">
                                <form action="frontend/book_home_visit" method="get" class="form-div">
                        ...
                        <div class="col-md-12 col-lg-7 col-xl-8">
                            <?php if(count($doctors_data)==0 && count($hospitals) ==0){ ?>
                                        ...
                                        <div class="doc-info-right">
                                            <div class="clini-infos">
                                                <ul>
                                                    ...
                                                    <li><i class="far fa-money-bill-alt"></i> <?php if($value->home_fee !=""){ echo $value->symbol.' '.$value->home_fee; }else{ echo 'Free';} ?> <i class="fas fa-info-circle" data-toggle="tooltip" title="Appointment Fee"></i> </li>
                                                </ul>
                                            </div>
                                            <div class="clinic-booking">
                                                <a class="view-pro-btn" href="frontend/doctor_profile/<?php echo $value->id ?>">View Profile</a>
                                                <a class="apt-btn" href="frontend/book_doctor_home_visit/<?php echo urlencode($value->id); ?>">Book Appointment</a>
						...
						<?php foreach($hospitals as $row) { ?>
							<div class="doctor-cards card">
                                <div class="card-body">
                                    <div class="doctor-widget">
                                        <div class="doc-info-left">
                                            <div class="doctor-img">
                                                <img src="new_assets/img/contact-us-bg.jpeg" class="img-fluid" alt="User Image">
                                            </div>
                                            <div class="doc-info-cont">
                                                <h4 class="doc-name"><?= $row->name; ?></h4>
                                                <div class="clinic-details">
                                                    <p class="doc-location">
														<i class="fas fa-map-marker-alt"></i> <?= $row->address; ?><br>
														<a href="mailto:<?= $row->email; ?>"><i class="fa fa-envelope"></i> <?= $row->email; ?></a><br>
														<a href="mailto:<?= $row->phone; ?>"><i class="fa fa-phone"></i> <?= $row->phone; ?></a><br>
													</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="doc-info-right">
                                            <div class="clinic-booking">
                                                <!-- <a class="view-pro-btn" href="mailto:<?= $row->email; ?>">Contact Us</a> -->
                                                <a class="view-pro-btn" href="frontend/book_doctor_by_hospital/<?= $row->id; ?>">Request for Booking</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
