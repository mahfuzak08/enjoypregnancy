    ...
    <body>
        ...
        <div class="fullwidthbanner-container">
          <div class="container" style="z-index: 1;position: relative;">
              <h1 class="text-center" style="color: #fff;font-weight: bold;">Urgent Consultation</h1>
              <p class="text-center" style="color: #fff;font-weight: bold;"><a href="frontend">Home</a> / Urgent Consultation</p>
        ...
        <div class="container">
            ...
            <h4 class="text-center">If you have any of the symptoms listed below, please do not book a home visit appointment.</h4>
            <h4 class="text-center">Fever, cough, loss of smell & taste, breathing difficulties, chest tightness & wheezing.</h4>
            <br>
            <h2 class="text-center">Book your appointment for Urgent Consultation. </h2>
            <h4 class="text-center">Once your booking is complete a member of the team will be in touch to schedule a specific time for you.</h4>
            <br>
            <form role="form" action="request/homevisit" class="clearfix home-form" method="post">
                ...
                <div class="col-md-4">
                    <div class="">
                        <div class="col-md-12 payment pad_bot">
                            ...
                            <input type="date" class="form-control pay_in" name="dob" placeholder="Full Name" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="clearfix">
                        <div class="col-md-12 payment pad_bot">
                            ...
                            <input type="text" class="form-control pay_in" name="email" placeholder="Phone Number" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="">
                        <div class="col-md-12 payment pad_bot">
                            ...
                            <input type="date" class="form-control pay_in" name="date" placeholder="Date" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-12 text-center">
                    <br>
                    <button type="submit" name="submit" class="btn btn-success btn-lg"> <?php echo '£30 Book Appointment'; ?></button>
                </div>
            </form>
        </div>
