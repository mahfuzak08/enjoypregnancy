                    ...
                    <div class="clearfix row">
                        ...
                        <form role="form" action="settings/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label>
                                <input type="radio" name="meeting_room" value="meet_jitsi" <?php if($settings->meeting_room=="meet_jitsi") echo 'checked'; ?>> <?php echo 'Meet.jitsi'; ?>
                                </label> &nbsp;&nbsp;
                                <label>
                                <input type="radio" name="meeting_room" value="meet_simra" <?php if($settings->meeting_room=="meet_simra") echo 'checked'; ?>> <?php echo 'Simra.org'; ?>
                                </label>
                            </div>
