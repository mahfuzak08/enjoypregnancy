                        ...
                        <?php foreach ($pharmacists as $pharmacist) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    ...
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="home/deletepharmacist?id=<?php echo $pharmacist->id; ?>" title="<?php echo lang('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> </a>
                                </td>
                            </tr>
                        <?php } ?>
