...
class Lab extends MX_Controller {
    ...
    public function addLabView() {
        ...
        // $data['patients'] = $this->patient_model->getPatient();
        // $data['doctors'] = $this->doctor_model->getDoctor();
         if($this->input->get('type') == 1) $this->load->view('home/css'); else  $this->load->view('home/dashboard'); // just the header file
        $this->load->view('add_lab_view', $data);
        $this->load->view('home/footer'); // just the header file
    }
...
// Validating Description Field
    ...
    function invoice() {
        ...
        if($this->input->get('type') == 1)     $this->load->view('home/css');
         else $this->load->view('home/dashboard'); // just the header file
...
// } 
    ...
    function diagnosticResults()
    {
        ...
        $this->load->view('home/dashboard'); // just the header file
        $this->load->view('diagnostic_results', $data);
        $this->load->view('home/footer'); // just the header file
    }
