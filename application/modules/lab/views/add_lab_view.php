    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel col-md-7 no-print">
            <header class="panel-heading no-print">
                <?php
                if (!empty($lab->id))
                    echo 'Edit Diagnostic Form';
                else
                    echo 'Add Diagnostic Form';
                ?>
            </header>
            <div class="no-print">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" id="editLabForm" class="clearfix" onsubmit="return mySubmitFunction(event)" method="post" enctype="multipart/form-data">
							<input type="hidden" name="formopeninfo" value="<?= @$_GET['type']; ?>">
                            <div class="">
                            ...
                            <div class="col-md-12 lab"> 
                                <button type="submit" id="subnitBtn" name="submit" class="btn btn-info pull-right"><?php echo lang('submit'); ?></button>
                            </div>
        ...
        <section class="panel col-md-4">
            ...
            <div class="panel panel-primary" style="margin: 2% 3%;">
                    ...
                    <div class="row invoice-list">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"> <?php echo 'Diagnostic'; ?> <?php ?> <?php echo lang('id'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($lab->id)) {
                                                echo $lab->id;
                ...
                <div class="text-center invoice-btn col-md-3 pull-right">
                    <a class="btn btn-info btn-lg invoice_button" onclick="javascript:window.print();"><i class="fa fa-print"></i> <?php echo lang('print'); ?> </a>
                </div>


                <div class="no-print col-md-9 pull-right">
                    <a href="lab/addLabView" class="">
                        <div class="btn-group">
                            <button id="" class="btn green">
                                <i class="fa fa-plus-circle"></i> <?php echo 'Add New Diagnostic Form'; ?>
                            </button>
                        </div>
                    </a>
                </div>
            ...
            <div class="modal-body">
                <!--<form role="form" action="patient/addNew?redirect=lab" method="post" enctype="multipart/form-data">-->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id="exampleInputEmail2" value='' placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail3">Phone</label>
                        <input type="text" class="form-control" name="phone" id="exampleInputEmail3" value='' placeholder="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail4">Image</label>
