                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($categories as $category) { ?>
                            <tr class="">
                                ...
                                <td><?php $parent_res = $this->medicine_model->getparentcategories($category->parent_id); if($parent_res['category_name']!=""){ echo $parent_res['category_name']; }else{ echo "---";} ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="medicine/edit_category?id=<?php echo $category->id; ?>" class="btn btn-info btn-xs btn_width" data-id="<?php echo $category->id; ?>"><i class="fa fa-edit"> <?php echo lang('edit'); ?></i></a>   
