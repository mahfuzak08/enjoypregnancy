    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo 'List of Questions & Answers'; ?>
                <div class="col-md-4 no-print pull-right"> 
                    <a href="symptomchecker/addquestionanswer">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <tbody>
                            <?php $i=1; foreach ($questionandanswers as $value) { ?>
                                <tr class="">
                                    <td><?php echo $i++; ?></td>
                                    ...
                                    <td class="no-print">
                                        <a href="symptomchecker/editquestionsAndanswers/<?php echo $value->id; ?>" type="button" class="btn btn-info btn-xs btn_width" title="<?php echo lang('edit'); ?>"><i class="fa fa-edit"></i> Edit</a>   
                                        <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="speciality/deletequestionsandanswers?id=<?php echo $value->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i> Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
