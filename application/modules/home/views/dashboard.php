...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <body>
        <section id="container" class="">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu extended logout">
                                ...
                                <?php if (!$this->ion_auth->in_group('admin')) { ?> 
                                    <li><a href="home"><i class="fa fa-home"></i> <?php echo lang('dashboard'); ?></a></li>
                                <?php } ?>
            ...
            <!--sidebar start-->
            <aside>
                <?php $display_none=""; if ($this->ion_auth->in_group('Doctor')) {
                $auth_id = $this->ion_auth->get_user_id();
                $this->db->where('ion_user_id',$auth_id);
                $res_doctor = $this->db->get('doctor')->row_array();
                if($res_doctor['is_approved']==0 or $res_doctor['is_approved']==2){
                ...
                <?php } } ?>
                <div id="sidebar"  class="nav-collapse" style="<?php echo $display_none; ?>">
                    <!-- sidebar menu start-->
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li>
                            <a href="home"> 
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            ...
                            <?php } ?>
                                <!--<li>-->
                                <!--    <a href="appointment/homevisitappointments">-->
                                <!--        <i class="fa fa-sitemap"></i>-->
                                <!--        <span><?php echo 'Home Visit Appointments'; ?></span>-->
                                <!--    </a>-->
                                <!--</li>-->
                        <?php } ?>
 ...
 <?php if (in_array('patient', $this->modules)) { ?>
                                            ...
                                            <li>
                                                <a href="patient/patient_frm_tem/">
                                                    <i class="fal fa-hospital-user"></i><span> Patient form templates</span>
                                                </a>
                                            </li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('Patient'))) { ?>
                            <?php if (in_array('appointment', $this->modules)) { ?>
                                <li><a href="appointment/myTodays"><i class="fa fa-headphones"></i><?php echo lang('today'); ?> <?php echo lang('appointments'); ?></a></li>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <?php if (in_array('finance', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <li><a  href="payment/bank_transfer"><i class="fa fa-money-check"></i> Bank Transfer <span class="badge bg-warning"></span></a></li>
                        ...
                        <?php if (in_array('prescription', $this->modules)) { ?>
                                ...
                                <li>
                                    <a href="prescription/bodycharttemplate/">
                                        <i class="fa fa-bone-break"></i>
                            ...
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                        ...
                                        <span><?php echo 'Diagnostic Tests'; ?></span>
                                    </a>
                                    <ul class="sub">
                                        <li><a  href="lab"><i class="fa fa-file-medical"></i><?php echo 'Diagnostic Forms'; ?></a></li>
                                        <li><a  href="lab/addLabView"><i class="fa fa-plus-circle"></i><?php echo "Add Diagnostic Form"; ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('Pharmacist'))) { ?>
                        	<li>
                                    <a href="finance/pharmacy/porders"> 
                                        <i class="fa fa-money-check"></i>
                                        <span>Orders</span>
                                        <span class="badge bg-warning">
                        ...
                        <li class="sub-menu">
                                ...
                                <ul class="sub"> 
                                    <li><a href="doctor/add_new_blog"><i class="fa fa-credit-card"></i><?php echo 'Add new Blog'; ?></a></li>
                                    <li><a href="<?php echo base_url(); ?>doctor/blogs"><i class="fa fa-language"></i><?php echo 'View All Blogs'; ?></a></li>
                                </ul>
                            </li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { 
                            ...
                            $res_num_blogs = $this->db->get('posts')->num_rows();
                        ?>
                            <li>
                                <a href="doctor/blog_requests" style="position:relative">
                                    <i class="fa fa-book"></i>
                                    <span>Blog Requests</span>
                                    <span class="badge bg-warning"><?php echo $res_num_blogs ?></span>
                                </a>
                            </li>
                        <?php } ?>
                            ...
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li>
                                    <a href="lab/myLab" >
                                        ...
                                        <span> <?php echo lang('diagnostic'); ?> <?php echo lang('investigations'); ?> </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="lab/diagnosticResults" >
                                        <i class="fa fa-file-medical-alt"></i>
                                        <span> <?php echo lang('diagnostic'); ?> <?php echo 'Results'; ?> </span>
                                    </a>
                                </li>
                            <?php } ?>
                            <?php if (in_array('appointment', $this->modules)) { ?>
                            ...
                            <?php if (in_array('report', $this->modules)) { ?>
                                <li>
                                    <a href="report/myreports" >
                                        <i class="fa fa-file-medical-alt"></i>
                                        <span> <?php echo lang('diagnostic'); ?> <?php echo lang('reports'); ?> </span>
                                    </a>
                                </li>
                            <?php } ?>
                            <?php if (in_array('donor', $this->modules)) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group('superadmin')) { ?>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="speciality/addNew"><i class="fa fa-wrench"></i><?php echo 'Add New Speciality'; ?></a></li>
                                    <li><a href="speciality"><i class="fa fa-smile"></i><?php echo 'Speciality List'; ?></a></li>
                                </ul>
                            </li>
                            <!--Speciality end here-->
                            <!--Symptom Checker'-->
                            <li class="sub-menu">
                                <a href="javascript:;" >
                                    <i class="fa fa-plus-circle"></i>
                                    <span><?php echo 'Symptom Checker'; ?></span>
                                </a>
                                <ul class="sub">
                                    <!-- <li><a href="speciality/addNew"><i class="fa fa-plus"></i><?php echo 'Add Symptom'; ?></a></li> -->
                                    <li><a href="symptomchecker"><i class="fa fa-wrench"></i><?php echo 'Symptoms List'; ?></a></li>
                                    <!-- <li><a href="speciality"><i class="fa fa-plus"></i><?php echo 'Add Questions & Ans...'; ?></a></li> -->
                                    <li><a href="symptomchecker/questionsAndanswers"><i class="fa fa-smile"></i><?php echo 'Question & Answers'; ?></a></li>
                                </ul>
                            </li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('superadmin'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
									...
									<li><a href="frontend" target="_blank" ><i class="fa fa-globe"></i><?php echo lang('visit_site'); ?></a></li>
                                    <!--<li><a href="#" target="_blank" ><i class="fa fa-globe"></i><?php echo 'Home Page'; ?></a></li>
                                    <li><a href="#"><i class="fa fa-cog"></i><?php echo 'Pharmacy Page'; ?></a></li>
                                    <li><a href="#"><i class="fa fa-wrench"></i><?php echo 'Lab Test Page'; ?></a></li>
                                    <li><a href="#"><i class="fa fa-smile"></i><?php echo 'Health A-Z'; ?></a></li>-->
                                </ul>
                            </li>
							<li class="sub-menu">
                                <a href="javascript:;" >
                                ...
                                <ul class="sub">
									<li><a href="settings/manage_api?t=call"><i class="fa fa-globe"></i>Calling Gateway</a></li>
									<li><a href="settings/manage_api?t=chat"><i class="fa fa-globe"></i>Chatting Server</a></li>
									<!--<li><a href="settings"><i class="fa fa-globe"></i>Jitsi</a></li>
									<li><a href="settings"><i class="fa fa-globe"></i>Simra</a></li>-->
									<li><a href="settings/manage_api?t=squareup"><i class="fa fa-globe"></i>Square-up Payment</a></li>
									<li><a href="settings/manage_api?t=stripe"><i class="fa fa-globe"></i>Stripe Payment</a></li>
									<li><a href="settings/manage_api?t=sms"><i class="fa fa-globe"></i>SMS Gateway</a></li>
									<li><a href="settings/manage_api?t=firebase"><i class="fa fa-globe"></i>Firebase</a></li>
									<li><a href="settings/manage_api?t=currency"><i class="fa fa-globe"></i>Currency Conversion</a></li>
									<li><a href="settings/manage_api?t=giphy"><i class="fa fa-globe"></i>Giphy</a></li>
                                </ul>
                            </li>
                            <li><a href="settings/faq"><i class="fa fa-question-circle"></i>FAQ</a></li>
                            <li><a href="settings"><i class="fa fa-cog"></i><?php echo lang('system_settings'); ?></a></li>
                            <li><a href="settings/language"><i class="fa fa-language"></i><?php echo lang('language'); ?></a></li>
                        <?php } ?>
