...
<section id="main-content">
    <section class="wrapper site-min-height">
        <?php if ($this->ion_auth->in_group('admin') and $this->session->userdata('is_hospital')==1) { ?>
        <br>
                    ...
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        ...
                        <section class="panel panel-moree">
                            ...
                            <div class="value">
                                ...
                                <h1 class="">
                                    <?php echo $settings->currency; ?> <?php echo number_format(0, 2, '.', ','); ?>
                                </h1>
                            </div>
                        </section>
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
        ...
        <?php } else { ?>
            ...
            <section class="col-md-12">
                <div class="col-lg-6 col-sm-6 row">
                    <h1><span class="livee"><?php echo lang('live'); ?></span> <?php echo $heading_live; ?></h1>
                </div>
            </section>
