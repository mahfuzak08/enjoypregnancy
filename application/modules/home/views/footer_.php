<footer class="site-footer">
    <div class="text-center"> 
        20<?php echo date('y'); ?> &copy; <?php echo $this->db->get('settings')->row()->system_vendor; ?> by Call GP Now.
...
<?php
  if ($this->ion_auth->in_group('Doctor')) {
      echo '<script type="text/javascript" src="https://callgpnow.com/public/common/twilio.min.js"></script>';
  }
?>
