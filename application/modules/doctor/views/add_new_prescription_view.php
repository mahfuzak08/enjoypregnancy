			...
			<form role="form" action="prescription/addNewPrescription" class="clearfix" method="post" enctype="multipart/form-data">
				<div class="row form-row">
					<div class="form-group col-md-4">
						...
						elseif (!empty($prescription->date)) {
					...
					<div class="form-group col-md-12 medicine_block">
						...
						<div class="row">
							<div class="col-md-4">
								<label class="control-label"> <?php echo lang('medicine'); ?></label><br><br><br>
...
<script>
    ...
    function addmoremedicines()
    {
        var rand_id = Math.floor((Math.random() * 100) *100);
        $(".medicine").append('<section id="med_selected_section-' + rand_id + '" class="med_selected row">\n\
         <div class = "form-group medicine_sect col-md-2"><div class=col-md-12>\n\
        <label> <?php echo lang("medicine"); ?> </label>\n\
        </div>\n\
        \n\
        <div class=col-md-12>\n\
        <input class = "medi_div" name = "med_id[]" value = "' + '" placeholder="" required>\n\
         <input type="hidden" id="med_id-' + '" class = "medi_div" name = "medicine[]" value = "' + rand_id + '" placeholder="" required>\n\
         </div>\n\
         </div>\n\
        \n\
        <div class = "form-group medicine_sect col-md-2" ><div class=col-md-12>\n\
        ...
        <div class=col-md-12><input class = "potency medi_div sale" id="salee' + '" name = "frequency[]" value = "' + '" placeholder="1 + 0 + 1" required>\n\
        </div>\n\
        </div>\n\
        \n\
        <div class = "form-group medicine_sect col-md-2"><div class=col-md-12>\n\
        ...
        <div class=col-md-12><input class = "potency medi_div quantity" id="quantity' + '" name = "days[]" value = "' + '" placeholder="7 days" required>\n\
        </div>\n\
        </div>\n\
        \n\
        \n\<div class = "form-group medicine_sect col-md-2"><div class=col-md-12>\n\
        ...
        <div class=col-md-12><input class = "potency medi_div quantity" id="quantity' + '" name = "instruction[]" value = "' + '" placeholder="After Food" required>\n\
        </div>\n\
        </div>\n\
        \n\
        \n\
         <div class="del col-md-1"></div><i class="fa fa-times" onclick="removemedicinediv('+rand_id+')" style="color: red;position: absolute;right: 32px;"></i>\n\
        </section>');
    }
    function removemedicinediv(val)
    {
        $('#med_selected_section-'+val).remove();
    }
    </script>