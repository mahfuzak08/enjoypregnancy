        ...
        <div class="col-md-8 panel bg_container margin_top" id="prescription">
            <div class="bg_prescription">
                <div class="panel-body">
                    ...
                    <div class="col-md-4 pull-right text-right top_logo"> <img src="<?php echo $settings->logo; ?>" onerror="this.src='uploads/logo.png'" width="100%"></div>
                </div>
                <hr>
                <div class="panel-body">
                    <div class="">
            ...
            <div class="panel-body prescription_footer">
                <div class="col-md-6 pull-left" style="font-size: 12px;">
                 <div class="row"> 
                    <div class="col-md-3 text-center" style="padding: 0px;">
                        <img src="<?php echo $doctor->img_url; ?>" onerror="this.src='uploads/default.jpg'" class="thumbnail" width="100%" style="border-radius: 100%;">
                    </div>
                    <div class="col-md-9">
                     ...
                     <p><strong>Address: </strong><?php $address_i = json_decode($doctor->address); echo $address_i[0].' '.$address_i[1]; ?></p>
                    </div>
                 </div>
