            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <form role="form" action="hospital/addNew" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div <?php if($this->session->userdata('is_hospital') !=0){ echo "style='display:none'";} ?>>
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo lang('package'); ?></label>
                                <select class="form-control m-bot15 pos_select" id="pos_select" name="package" value=''>
                                    <option value=""> - - - </option>
                                    <option value="" <?php
                                    if (!empty($hospital->id)) {
                            ...
                            <div class="form-group"> 
                                ...
                                <input type='checkbox' value = "orders" name="module[]"
                                       ...
                                       > <?php echo 'Orders'; ?>
                                <br>
                                <input type='checkbox' value = "pharmacists" name="module[]"  <?php
                                if (!empty($hospital->id)) {
                                    if (in_array('pharmacists', $modules1)) {
                                        echo 'checked';
                                    }
                                } else {
                                    echo 'checked';
                                }
                                ?>> <?php echo 'Pharmacists'; ?> 
                                <br>
                                <input type='checkbox' value = "salesman" name="module[]"  <?php
                                if (!empty($hospital->id)) {
                                    if (in_array('salesman', $modules1)) {
                                        echo 'checked';
                                    }
                                } else {
                                    echo 'checked';
                            ...
                            <?php }elseif($this->session->userdata('is_hospital')==2){ ?>
                        ...
                        <input type="hidden" name="redirect" value="hospital/pharmacies">
                        <?php }elseif($this->session->userdata('is_hospital')==2){ ?>
                        <input type="hidden" name="is_hospital" value="2">
                        <input type="hidden" name="redirect" value="hospital/laboratories">
                        <?php } ?>
