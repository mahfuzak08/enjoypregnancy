                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        foreach ($holidays as $holiday) {
                            ...
                            <tr class="">
                                ...
                                <td> <?php echo $holiday->date;//date('d-m-Y', $holiday->date); ?></td> 
                                <?php if ($this->ion_auth->in_group(array('admin', 'Doctor'))) { ?>
                                    <td>
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addHoliday" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6 pull-right">
                        ...
                        <input type="text" class="form-control default-date-picker11" name="date" id="exampleInputEmail1" value='' readonly="">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editHolidayForm" class="clearfix" action="schedule/addHoliday" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6 pull-right">
                        <label for="exampleInputEmail1"> <?php echo lang('date'); ?></label>
                        <input type="text" class="form-control default-date-picker111" name="date" id="exampleInputEmail1" value='' readonly="">
                    </div>
...
$(document).ready(function () {
    $(".editbutton").click(function (e) {
        ...
        $.ajax({
            ...
            $('#editHolidayForm').find('[name="date"]').val(response.holiday.date).end()
            ...
            updatedateformat(response.holiday.date);
        });
    });
});
</script>
